    ...
    public class LeaveRequestRepository : GenericRepository<LeaveRequest>, ILeaveRequestRepository
    {
        ...
        public async Task ChangeApprovalStatus(int leaveRequestId, bool approved)
        {
            ...
            await emailSender.SendEmailAsync(user.Email, $"Leave Request {approvalStatus}", $"Your leave request from " +
                $"{leaveRequest.StartDate} to {leaveRequest.EndDate} has been submitted to {approvalStatus}");
        }
        ...
        public async Task<bool> CreateLeaveRequest(LeaveRequestCreateVM model)
        {
            ...
            await emailSender.SendEmailAsync(user.Email, "Leave Request Submitted Successfully", $"Your leave request from " +
                $"{leaveRequest.StartDate} to {leaveRequest.EndDate} has been submitted to approval");
        ...
        {
            var leaveRequests = await context.LeaveRequests.Include(x => x.LeaveType).ToListAsync();
